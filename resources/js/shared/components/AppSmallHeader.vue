          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <router-link class="dropdown-item" to="/jobs"><i data-feather="grid"></i> Pickups</router-link>
                <router-link class="dropdown-item" to="/jobs/create"><i data-feather="briefcase"></i>  Schedule a Pickup</router-link>
